...
\begin{align*}
    T(n) &= \left[ T \left( \frac{n}{2^i} \right) + \sum_{k=0}^{i-1} \left( \log_{2}\frac{n}{2^k} \right) \right] + 1
\end{align*}
...
\begin{quote}
    "The values of the world we inhabit and the people we surround ourselves with have a profound effect on who we are." \cite{gladwell}
\end{quote}
